...
- [x] Compile the Project - All tests passing (0.004s)

- [x] Create and Run Task - Tests run successfully with `go test -v`

- [x] Launch the Project - Library ready to use

- [x] Ensure Documentation is Complete - README.md with examples included
